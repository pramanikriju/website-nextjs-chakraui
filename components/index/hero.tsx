    ...
    <Container maxW={"7xl"}>
      ...
      >
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Text color={"gray.500"}>
            Supercharge your business, get measurable results. Navigate the
            digital domain with confidence and ease. Be it a website or a mobile
            app. Book a session today to learn more.
          </Text>
          <Stack
            spacing={{ base: 4, sm: 6 }}
